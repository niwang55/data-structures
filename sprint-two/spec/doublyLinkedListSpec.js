describe('doublyLinkedList', function() {
  ...
  it('should add all nodes in order', function() {
  ...
  it('should be doubly linked', function() {
    ...
    expect(doublyLinkedList.tail.previous.value).to.equal(2);
    expect(doublyLinkedList.head.next.value).to.equal(2);
    expect(doublyLinkedList.head.next.next.value).to.equal(3);
    expect(doublyLinkedList.tail.previous.previous.value).to.equal(1);
  });

  it('should add to the head when addHead is invoked', function() {
    doublyLinkedList.addToTail(1);
    doublyLinkedList.addToTail(2);
    doublyLinkedList.addToTail(3);
